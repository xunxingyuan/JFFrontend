  ...
  <div class="authConfig flex">
    <div class="settingType">
      <el-checkbox-group v-model="robotChoseList" @change="robotListChange">
        <div class="typeItem" v-for="item in robotList" :class="{'active': selectRobot === item}" @click.stop="choseRobot(item)">
    ...
    <div class="settingContent">
      ...
      <el-checkbox-group v-model="checkList" @change="authListChange">
        <div class="contentMenu">
          ...
          <div class="authContent second">
            <el-checkbox-group v-model="countList" @change="secondChange" :disabled="checkList.indexOf('统计分析')===-1">
      ...
      <el-checkbox-group v-model="checkList" @change="authListChange">
        <div class="contentMenu">
          ...
          <div class="authContent second">
            <el-checkbox-group v-model="countList" @change="secondChange" :disabled="checkList.indexOf('机器人设置')===-1">
...
//        console.log(this.robotChoseList)
      ...
      choseRobot: function (item) {
        ...
        if(checkResult){
          this.editAuth = JSON.parse(JSON.stringify(this.authResult[checkResult-1]))
          this.countList = []
          this.checkList = []
      ...
      getRobotAuth: function (robotId) {
        return new Promise((resolve,reject)=>{
          this.$api.user.userGroup.getGroupAuth({
