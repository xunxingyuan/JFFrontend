<template>
  <div class="qaEdit">
    ...
    <div class="qaBox animated fadeInRight">
      ...
      <div class="topTitle">
        <p class="title" v-if="editType==='create'">新建QA</p>
        <p class="title" v-if="editType==='edit'">编辑QA</p>
      </div>
      <div class="contentInner">
        <div class="editItem">
          ...
          <div class="itemContent">
            <el-input v-model="qaData.question"></el-input>
          </div>
          <div class="itemCtrl">
        ...
        <div class="editItem">
          ...
          <div class="itemContent">
            ...
            <div class="extra">槽点<span class="blue">{{qaData.slotList.length}}</span>个 <span class="blue" @click="viewSameView(2)">查看</span></div>
          </div>
          <div class="itemCtrl flexCenter" >
            <div class="add flexCenter" @click="addSlotData">
              <i class="fas fa-plus"></i>
            </div>
          </div>
        </div>
      ...
      <div class="submitBox flexCenter">
        <el-button @click="submitData" title="保存当前QA">保存</el-button>
        <el-button type="primary" class="submit" title="保存当前QA并生成AIML" @click="submitAndAiml">提交</el-button>
...
<script>
  ...
  export default {
    components: {
      ...
      QuillEditor},
    name: 'qaEdit',
    props:['editType','editData','tree','categoryId'],
    data(){
      return {
        props: {
          label: "categoryName",
    ...
    methods:{
      ...
      submitData: function () {
        ...
        if(submitData.categoryId === 'weifenlei'){
      ...
      submitAndAiml: function () {
        ...
        if(this.qaData.question.trim()&&this.qaData.answer.trim()&&this.qaData.effDate.trim()&&this.qaData.expDate.trim()){
          if(submitData.categoryId === '0'){
            ...
            this.$emit('submitAndAiml',submitData)
            this.close()
          }
        }else{
          this.$message({
