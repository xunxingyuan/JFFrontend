<template>
  <div class="qaEdit" @click="similarDataList = []">
    ...
    <question-slot
      v-if="slotShow"
      :slotData="slot"
      @editSlotItem="editSlotItem"
      @close="slotShow = false"
      ...
      <div class="contentInner scrollbar">
        <div class="bgBlock">
          <div class="editItem">
            ...
            <div class="itemCtrl"></div>
            <div class="similarBox" v-if="similarDataList.length!==0">
              <p v-for="item in similarDataList">{{item.question}}</p>
            </div>
          </div>
          <div class="editItem">
            <div class="itemName">句式</div>
            <div class="itemContent">
              <el-input v-model="patternData"></el-input>
              <div class="extra">句式
                <span class="blue">{{qaData.patternList.length}}</span>个
                <span class="blue" @click="viewSameView(0)">查看</span>
              </div>
            </div>
          ...
          <div class="editItem">
            <div class="itemName">相似问法</div>
            <div class="itemContent">
              <el-input v-model="similarData"></el-input>
              <div class="extra">相似问法
                <span class="blue">{{qaData.similarQuestionList.length}}</span>个
                <span class="blue" @click="viewSameView(1)">查看</span>
              </div>
            </div>
            <div class="itemCtrl flexCenter">
          ...
          <div class="editItem">
            <div class="itemName">槽点</div>
            <div class="itemContent">
              <el-input v-model="slotData"></el-input>
              <div class="extra">槽点
                <span class="blue">{{slot.length}}</span>个
                <span class="blue" @click="slotShow = true">查看</span>
              </div>
            </div>
            <div class="itemCtrl flexCenter">
        ...
        <div class="bgBlock">
          <div class="editItem">
            ...
            <div class="itemContent textHtml">
              <el-switch v-model="ifHtml" active-color="#13ce66" inactive-color="#D1D1D1"></el-switch>
...
export default {
  ...
  methods: {
    ...
    submitData: function(type) {
      ...
      if (
        this.qaData.question.trim() &&
        this.qaData.answer.trim() &&
        this.qaData.effDate.trim() &&
        this.qaData.expDate.trim()
      ) {
    ...
    filterHTMLTag: function(msg) {
      ...
      result = result.replace(/&npsp;/gi, ""); //去掉npsp
      return result;
    },
